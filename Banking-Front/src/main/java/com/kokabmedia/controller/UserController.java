...
public class UserController {
	 ...
	 * and inject (autowires) that instance into the UserController object when it is instantiated 
	 * as a autowired dependency.
	 * 
	 * The UserService bean and its implementation is now a dependency of the UserController class.
	 */
    @Autowired
    ...
    public String profile(Principal principal, Model model) {
		 ...
		 * variable "user" and a user will be shown coming in from the second parameter value. The model instance will make 
	 ...
	 * context of the HTML form body and bind the value to the User object in this method.
	 */
